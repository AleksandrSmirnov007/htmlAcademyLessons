...
import {onActiveForm} from './form.js';

// // работает но зум скролингом на карте мешает смотри решение ниже
// const map = L.map('map')
//   .on('load', () => {
...
//   updateAddress(`По широте: ${coordinates.lat}, По долготе: ${coordinates.lng}`);
// };
