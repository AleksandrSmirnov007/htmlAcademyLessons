...
filterForm.addEventListener('change', () => { // убрать отсюда и экспортировать в осной обработчтк событий  в модуль form.js (переадть через callback form через main,  ) применить при фильрации обьявлений
...
export {
  ...
  onMoveendMainPin,
  renderMarkers,
  closeMapPopup // не забыть импортировать в main
};
