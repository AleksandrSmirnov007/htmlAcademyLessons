...
console.log(preview, fileChooser);
...
// При изменении состояния fileChooser меняется свойство files, в него вставляется список выбранных файлов (файлов ведь несколько можно выбрать). В ТЗ предполагается выбирать только один файл, поэтому выбираем первый элемент, обращаясь по индексу 0.
